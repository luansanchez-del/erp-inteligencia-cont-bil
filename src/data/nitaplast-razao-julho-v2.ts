...
function mapearEntrada(gerencial: string, cc: string): MapeamentoEntrada | null | "duplicado-fiscal" {
  ...
  // 11.01.001/CC201 possui 21 documentos na fonte Softdib e representa compras
  // de produtos para revenda/materiais diretos. A entrada real volta a compor a
  // conta-ponte de compras; os créditos fiscais permanecem nas apurações oficiais.
  if (gerencial === "11.01.001" && cc === "201") return {
    debitoCodigo: "3093",
    creditoCodigo: "1496",
    status: "revisar",
    observacao: "21 documentos de compras para revenda/materiais diretos reincorporados ao custo conforme fonte Softdib; manter revisão analítica por fornecedor/CFOP.",
  };
