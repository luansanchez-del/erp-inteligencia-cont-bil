 ...
 * - juros, rendimentos, IOF/IRRF de aplicações e variação cambial permanecem fora do
 *   resultado nesta etapa, conforme orientação do usuário;
...
export const controlesBancariosJulho = {
  ...
  itauTrustDi: {
    ...
    irrfPeriodo: 551.11,
    saldoBrutoFinal: 0,
    observacao: "Extrato do fundo TRUST DI. Nesta etapa, somente aplicações e resgates líquidos que transitam no banco entram automaticamente; resultado financeiro permanece manual.",
  },
  bancoBrasil: {
    contaContabil: "10",
 ...
 * analiticamente, nem resultado financeiro.
 */
