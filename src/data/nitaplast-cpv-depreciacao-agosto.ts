...
export const lancamentosComprasCpvAgosto: LancamentoIntegrado[] = [
  ...
  base({ id: "AGO-CUSTO-MP-NAC", data: "31/08/2026", origem: "ENTRADAS POR CC 08/2026", debitoCodigo: "3093", creditoCodigo: "25116", historico: "Matéria-prima e insumos nacionais — Matriz", documento: "11.01.003 / CC 102 / 7 documentos", cc: "102", centroCusto: "PRODUÇÃO", valor: 856_124.54, observacao: "Compra bruta rastreada no relatório por centro de custo.", fonte: "RELATATORIO DETALHADO ENTRADAS POR CENTRO DE CUSTO - SOFTDIB 082026.csv" }),
    base({ id: "AGO-CUSTO-MP-IMP", data: "31/08/2026", origem: "ENTRADAS POR CC 08/2026", debitoCodigo: "3093", creditoCodigo: "25116", historico: "Matéria-prima e insumos de importação — NF 94222 — Greatland Valve", documento: "NF 94222 / NOP 3101 / CC 209 / 1 documento", cc: "209", centroCusto: "IMPORTAÇÃO", valor: 454_046.67, status: "revisar", observacao: "NF 94222, emitida em 18/08/2026, fornecedor Greatland Valve Company Limited (DUIMP 26BR0001376062-0). O valor integra a compra de matéria-prima importada. Fecha com a 25116 junto com a NF 94251 (mesmo processo) — ver baixas de tributos/despesas aduaneiras e contratos de câmbio em nitaplast-cambio-agosto.ts.", fonte: "RELATORIO DETALHADO ENTRADAS POR CENTRO DE CUSTO - SOFTDIB 082026.csv + RESUMO NOTAS FISCAIS ENTRADA.csv" }),
  base({ id: "AGO-CUSTO-MP-IMP-94251", data: "19/08/2026", origem: "NF-e 000.094.251", debitoCodigo: "3093", creditoCodigo: "25116", historico: "Matéria-prima e insumos de importação — NF 94251 — Greatland Valve", documento: "NF 94251, série 001 / DI 26/1426125.2", cc: "209", centroCusto: "IMPORTAÇÃO", valor: 109_923.88, status: "revisar", observacao: "NF 94251, emitida em 19/08/2026, fornecedor Greatland Valve Company Limited, referente à DUIMP 26BR0001426125-2 — mesmo processo da NF 94222 (achado em 18/09/2026, confirmado pelo cliente). Valor conferido linha a linha no DANFE: produtos R$ 66.406,80 + frete R$ 3.478,77 + outras despesas R$ 34.666,97 (II + PIS + COFINS + despesas aduaneiras) + IPI R$ 5.371,35 = R$ 109.923,89 (R$ 0,01 de arredondamento).", fonte: "DANFE NF-e 000.094.251, série 001, emitida 19/08/2026" }),
