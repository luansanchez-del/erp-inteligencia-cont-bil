...
export const lancamentosComprasCpvAgosto: LancamentoIntegrado[] = [
  ...
  base({ id: "AGO-CUSTO-MP-IMP", data: "31/08/2026", origem: "ENTRADAS POR CC 08/2026", debitoCodigo: "3093", creditoCodigo: "25116", historico: "Matéria-prima e insumos de importação — Matriz", documento: "11.01.003 / CC 209 / 1 documento", cc: "209", centroCusto: "IMPORTAÇÃO", valor: 454_046.67, status: "revisar", observacao: "Conta de matéria-prima e importação segue o único mapeamento contábil validado do mesmo gerencial; manter em revisão até conciliar DI/fornecedor.", fonte: "RELATATORIO DETALHADO ENTRADAS POR CENTRO DE CUSTO - SOFTDIB 082026.csv" }),
