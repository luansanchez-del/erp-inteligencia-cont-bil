...
export const lancamentosFolhaAgosto: LancamentoIntegrado[] = folhaAgostoDetalhe.flatMap((colaborador) => {
  ...
  adicionar("BEN", "1634", "1496", "descontos de plano de saúde e benefícios", colaborador.descontosBeneficios ?? 0, "Mensalidades e coparticipações discriminadas nos dados adicionais da folha. Corrigido em 23/09/2026: creditava 25263 (Credores Diversos) e nunca era baixado — mesma classificação contábil de 1496 (Fornecedores Diversos, 2.1.03.001.001), então passou a creditar diretamente 1496, a mesma conta que recebe a despesa da Unimed (ver nitaplast-servicos-questor-agosto.ts). Isso reduz automaticamente o saldo a pagar ao plano de saúde pelo valor retido dos funcionários, sem precisar de baixa manual separada.");
