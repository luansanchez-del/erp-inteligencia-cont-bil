...
const lancamentosMatriz:LancamentoIntegrado[] = folhaMatrizDetalhe.flatMap((e)=>{
  ...
  if(e.assistencia) a.push(l({id:`JUL-FOL-M-${e.matricula}-BEN`,data:"31/07/2026",origem:"FOLHA MATRIZ 07/2026",debitoCodigo:"1634",creditoCodigo:"1496",historico:`${base} - descontos assistência médica/odontológica`,documento:e.matricula,cc,centroCusto,valor:e.assistencia,observacao:"Valor efetivamente retido do empregado. Corrigido em 23/09/2026: creditava 25263 (Credores Diversos) e nunca foi baixado — mesma classificação contábil de 1496 (Fornecedores Diversos, 2.1.03.001.001), então passou a creditar diretamente 1496, a mesma conta que recebe a despesa da Unimed/Dental Uni. Reduz automaticamente o saldo a pagar ao plano de saúde, sem precisar de baixa manual separada.",fonte:fonteMatriz}));
