...
export function DreJulhoReport() {
  ...
  const grupos = useMemo(() => {
    ...
    return { custosMatriz, custosFilial, fechamentoEstoqueMatriz, fechamentoEstoqueFilial, componentesCpvMatriz, componentesCpvFilial, filial, matriz, industrializacao, depreciacao, creditosFederais, importacao, exportacao, veiculos, comerciais, administrativas, producao, outras, despesasFinanceiras, receitasFinanceiras };
  ...
  const linhas = useMemo<LinhaReport[]>(() => [
    ...
    { id: "resultado", descricao: "RESULTADO CONTÁBIL — ANTES DA BAIXA DOS ATIVOS VENDIDOS", valor: resultadoFinal, nivel: 0, tipo: "resultado" },
