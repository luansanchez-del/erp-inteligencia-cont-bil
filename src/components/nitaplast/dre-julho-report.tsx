...
export function DreJulhoReport() {
  ...
  const grupos = useMemo(() => {
    ...
    const classificaveis = matriz.filter((x) => x.conta !== "25937" && !x.classificacao.startsWith("5.7.01.011") && !creditosFederaisContas.has(x.conta));
    ...
    return { custosMatriz, custosFilial, outrosCustosMatriz, outrosCustosFilial, filial, matriz, industrializacao, depreciacao, creditosFederais, classificaveis, comerciais, administrativas, producao, outras, despesasFinanceiras, receitasFinanceiras };
  ...
  if (Math.abs(custosDre - arred(dre.cpvMatriz + dre.cpvFilial + dre.outrosCustosMatriz + dre.outrosCustosFilial)) > 0.01) throw new Error("CPV Matriz/Filial não concilia com Custos no DRE Report.");
  ...
  const linhas = useMemo<LinhaReport[]>(() => [
    ...
    { id: "rfp", descricao: "Receita Venda Produção — Filial SP", valor: receitaFiscalJulho.filialSp.producaoOperacaoTriangular, nivel: 1, tipo: "detalhe" },
    { id: "rfr", descricao: "Receita Revenda — Filial SP", valor: receitaFiscalJulho.filialSp.revenda, nivel: 1, tipo: "detalhe" },
    ...
    { id: "icms-f", descricao: "ICMS sobre vendas — Filial SP", valor: -dre.icmsFilial, nivel: 1, tipo: "detalhe" },
    ...
    { id: "cpv-m", descricao: "CPV — Matriz (25944)", valor: -dre.cpvMatriz, nivel: 1, tipo: "detalhe" },
    { id: "cpv-f", descricao: "CPV — Filial SP (25945)", valor: -dre.cpvFilial, nivel: 1, tipo: "detalhe" },
    { id: "cust-m", descricao: "Outros Custos — Matriz", valor: -dre.outrosCustosMatriz, nivel: 1, tipo: "detalhe" },
    { id: "cust-f", descricao: "Outros Custos — Filial SP", valor: -dre.outrosCustosFilial, nivel: 1, tipo: "detalhe" },
    ...
    { id: "industrializacao", descricao: "Despesas com Industrialização — Matriz", valor: -soma(grupos.industrializacao), nivel: 1, tipo: "detalhe" },
    { id: "nplog", descricao: "Despesa com Serviço - NPLog — Matriz", valor: -valorNplog, nivel: 1, tipo: "detalhe" },
    { id: "desp-producao", descricao: "Despesas Produção — Matriz", valor: -soma(grupos.producao), nivel: 1, tipo: "detalhe" },
    { id: "desp-comerciais", descricao: "Despesas Comerciais — Matriz", valor: -soma(grupos.comerciais), nivel: 1, tipo: "detalhe" },
    { id: "desp-adm", descricao: "Despesas Administrativas — Matriz", valor: -soma(grupos.administrativas), nivel: 1, tipo: "detalhe" },
    { id: "depreciacao", descricao: "Depreciação e Amortização — Matriz", valor: -soma(grupos.depreciacao), nivel: 1, tipo: "detalhe" },
    { id: "creditos-federais", descricao: "(-) Créditos PIS/COFINS sobre Custos e Despesas — Matriz", valor: -soma(grupos.creditosFederais), nivel: 1, tipo: "detalhe" },
    { id: "desp-outras", descricao: "Outras Despesas Operacionais — Matriz", valor: -soma(grupos.outras), nivel: 1, tipo: "detalhe" },
  ...
  ], [custosDre, despesasFinanceiras, despesasFilial, despesasOperacionais, dre, grupos, lucroBruto, receitaLiquida, resultadoFinal, resultadoOperacional, valorNplog]);
