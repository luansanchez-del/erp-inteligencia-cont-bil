...
export function DreJulhoReport() {
  ...
  const linhas = useMemo<LinhaReport[]>(() => [
    ...
    { id: "alien-rec", descricao: "(+) Venda de Ativo Imobilizado — Mini + Corolla", valor: dre.receitaAlienacaoImobilizado, nivel: 1, tipo: "detalhe" },
    { id: "alien-custo", descricao: "(-) Custo dos Ativos Imobilizados Vendidos", valor: -dre.custoAlienacaoImobilizado, nivel: 1, tipo: "detalhe" },
    { id: "alien-res", descricao: "(=) Ganho na Alienação — Mini + Corolla", valor: dre.resultadoAlienacaoImobilizado, nivel: 1, tipo: "subtotal" },
