...
export function BalanceteMaioDominio(){
 ...
 return <>
  ...
  <Card className="border-blue-500/30 bg-blue-500/5 print:hidden"><CardContent className="flex flex-wrap items-center justify-between gap-3 pt-5 text-sm"><div><strong>Fonte original preservada.</strong> Período {resumoBalanceteDominioMaio.periodo}. O DE/PARA para o Questor será uma camada separada.</div><Badge variant="outline">{resumoBalanceteDominioMaio.linhas} linhas · {resumoBalanceteDominioMaio.analiticas} analíticas</Badge></CardContent></Card>
