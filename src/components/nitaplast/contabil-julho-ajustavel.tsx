...
export function BalanceteJulhoAjustavel(){
  ...
  return <div className="grid gap-5">
    <Header titulo="Balancete consolidado - Nitaplast" descricao="Razão → Balancete → DRE. Cada conta informa se pertence à Matriz, Filial SP ou consolida ambos." acoes={<><Button variant="outline" size="sm" onClick={csv}><Download className="mr-2 size-4"/>Exportar CSV</Button><Button variant="outline" size="sm" onClick={()=>window.print()}><Printer className="mr-2 size-4"/>Imprimir / PDF</Button></>}/>
    ...
    <Card className="border-emerald-500/40 bg-emerald-50/40"><CardContent className="pt-5 text-sm"><strong>Balancete recalculável.</strong> O estabelecimento é herdado do Razão. Conta compartilhada com movimentos de ambos aparece como <strong>Matriz + Filial SP</strong>; não criamos saldo inicial segregado sem documento.</CardContent></Card>
