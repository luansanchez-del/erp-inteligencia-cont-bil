...
export function BalanceteJulhoAjustavel(){
  ...
  return <div className="grid gap-5">
    ...
    <Card className="border-blue-500/30 bg-blue-500/5"><CardContent className="flex flex-wrap items-center justify-between gap-3 pt-5 text-sm"><div><strong>Resumo do Balancete.</strong> Período 01/07/2026 a 31/07/2026. Saldos anteriores transportados de junho e movimentos mensais originados no Razão.</div><Badge variant="outline">{balancete.length} linhas · {balancete.filter(x=>x.tipo==="A").length} analíticas</Badge></CardContent></Card>
