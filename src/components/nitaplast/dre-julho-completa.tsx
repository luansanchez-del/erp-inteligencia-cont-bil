...
export function DreJulhoCompleta(){
  ...
  const linhas:Linha[]=[
    ...
    {id:"despesas",descricao:"(-) Despesas Operacionais",nivel:0,valor:despOper,criterio:"Despesas operacionais líquidas contabilizadas por documento/centro de custo.",composicao:grupos.despesas},
    ...
    {id:"resultado",descricao:"(=) RESULTADO CONTÁBIL 07/2026",nivel:0,valor:dreJulhoFinal.resultado,criterio:"Resultado calculado exclusivamente pelo Razão final de julho. Folha/provisões e depreciação permanecem fora até existir fonte de julho."},
  ];
  ...
  return <div className="grid gap-5">
    ...
    <Card className="border-amber-400/50 bg-amber-50/40"><CardContent className="pt-5"><div className="flex gap-3"><CircleAlert className="mt-0.5 size-5 text-amber-700"/><div><p className="font-semibold">Pendência de fonte, não de processamento</p><p className="mt-1 text-sm text-muted-foreground">No pacote desta conversa não foi localizada folha/provisões de 07/2026 nem ficha/mapa de depreciação de 07/2026. Por isso esses dois blocos não foram copiados de junho. Bancos, aplicações/rendimentos, impostos a recuperar/recolher, créditos PIS/COFINS, ICMS/IPI e estoques já estão contabilizados.</p></div></div></CardContent></Card>
  </div>
}
