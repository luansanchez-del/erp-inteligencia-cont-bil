...
export function DreJulhoCompleta() {
  ...
  const linhas: Linha[] = [
    ...
    { id: "alienacao", descricao: "Resultado na Alienação de Imobilizado — Matriz", nivel: 0, valor: dre.resultadoAlienacaoImobilizado, criterio: "As três vendas fiscais estão contabilizadas: Mini Cooper, Corolla e Transformador seco 1000KVA (NF 93639), 100% depreciado, ganho de capital pelo valor integral da venda." },
    ...
    { id: "alien-custo", descricao: "(-) Custo dos Ativos Imobilizados Vendidos — Mini + Corolla", nivel: 1, valor: dre.custoAlienacaoImobilizado, criterio: "Conta 4760. Mini residual R$ 52.500,00 + Corolla residual R$ 93.139,29. Transformador 100% depreciado, sem custo residual a baixar contra o resultado.", composicao: base.alienacaoCusto },
    { id: "alien-res", descricao: "(=) Ganho reconhecido na Alienação — Mini + Corolla + Transformador", nivel: 1, valor: dre.resultadoAlienacaoImobilizado, criterio: "R$ 67.400,00 Mini + R$ 33.860,71 Corolla + R$ 60.000,00 Transformador (venda integral, 100% depreciado) = R$ 161.260,71." },
